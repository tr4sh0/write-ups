...
(() => {
        ...
        const load = async () => {
            ...
            if (!storage) {
                localStorage.setItem('@iDashCredentials', JSON.stringify({
                    ...
                    client: '641354f8482193653c74389a'
                }));
            }
            ...
            loadBlipExtension((loader) => {
                ...
                const blipClient = new blipChatWidget().withAppKey(APP_KEY).withButton({
                    ...
                    blipClient.sendMessage({
                        type: "text/plain",
                        content: '641354f8482193653c74389a',
                        metadata: {
                ...
                if (client === '641354f8482193653c74389a') {
                    blipClient.withAuth({
    ...
    function ready(fn) {
        ...
        if (document.readyState !== 'loading') {
            ...
            // caso para navegadores sem suporte ao d
            document.addEventListener document.attachEvent('onreadystatechange', function() {
                if (document.readyState !== 'loading') fn();
            });
        }
    }
    ready(() => {
        document.documentElement.style.setProperty('--first-color', '#040a2b');
