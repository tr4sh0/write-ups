...
(() => {
        ...
        const load = async () => {
            ...
            if (!storage) {
                localStorage.setItem('@iDashCredentials', JSON.stringify({
                    ...
                    client: '64136461482193653c7459ad'
                }));
            }
            ...
            loadBlipExtension((loader) => {
                ...
                const blipClient = new blipChatWidget().withAppKey(APP_KEY).withButton({
                    ...
                    blipClient.sendMessage({
                        type: "text/plain",
                        content: '64136461482193653c7459ad',
                        metadata: {
                ...
                if (client === '64136461482193653c7459ad') {
                    blipClient.withAuth({
    ...
    ready(() => {
        document.documentElement.style.setProperty('--first-color', '#1c1c1c');
