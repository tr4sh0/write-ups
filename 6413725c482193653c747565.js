...
(() => {
        ...
        const load = async () => {
            ...
            if (!storage) {
                localStorage.setItem('@iDashCredentials', JSON.stringify({
                    ...
                    client: '6413725c482193653c747565'
                }));
            }
            ...
            loadBlipExtension((loader) => {
                ...
                const blipClient = new blipChatWidget().withAppKey(APP_KEY).withButton({
                    ...
                    blipClient.sendMessage({
                        type: "text/plain",
                        content: '6413725c482193653c747565',
                        metadata: {
                ...
                if (client === '6413725c482193653c747565') {
                    blipClient.withAuth({
    ...
    ready(() => {
        document.documentElement.style.setProperty('--first-color', '#1d1d1b');
